      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="pt-28 pb-16 bg-pattern">
          <div className="max-w-4xl mx-auto px-6 text-center space-y-5">
            <p className="divider-accent text-accent text-xs font-serif tracking-[0.3em] uppercase">Legal</p>
            <h1 className="font-serif text-5xl md:text-6xl text-black">Privacy Policy</h1>
            <p className="text-gray-500 text-lg">Last updated: March 1, 2026</p>
          </div>
        </section>
        ...
        <section className="py-20">
          <div className="max-w-3xl mx-auto px-6 space-y-12">
            ...
            <div className="border-t border-gray-100 pt-8 space-y-4">
              ...
              <ul className="space-y-3 text-gray-500 ml-6">
            ...
            <div className="border-t border-gray-100 pt-12">
              <div className="bg-light-bg rounded-2xl border border-gray-100 p-8 text-center space-y-4">
        ...
        <section className="bg-light-bg py-16">
          <div className="max-w-4xl mx-auto px-6 text-center space-y-8">
            ...
            <p className="text-gray-500 text-base">Dive into our curated collection of the world's finest scents.</p>
